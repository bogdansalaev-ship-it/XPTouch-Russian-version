...
int ui_temperatureComponent_pending_keypad_type = -1;
int ui_temperatureComponent_pending_keypad_index = -1;
int ui_temperatureComponent_pending_checked = -1;

void ui_temperatureComponent_show_backOrCancel()
{
    if (ui_temperatureComponent == NULL) return;
...
{
    if (ui_temperatureComponent_input_target == NULL) return;
...
void ui_temperatureComponent_hide_keypad()
{
    ...
    ui_temperatureComponent_pending_keypad_type = -1;
    ui_temperatureComponent_pending_keypad_index = -1;
...
void ui_temperatureComponent_show_pending_keypad(void)
{
    if (ui_temperatureComponent == NULL) return;
    if (ui_temperatureComponent_pending_keypad_type != -1)
    {
        ui_temperatureComponent_show_keypad(ui_temperatureComponent_pending_keypad_type, ui_temperatureComponent_pending_keypad_index);
        ui_temperatureComponent_pending_keypad_type = -1;
        ui_temperatureComponent_pending_keypad_index = -1;
    }
    if (ui_temperatureComponent_pending_checked != -1)
    {
        lv_obj_t *target = ui_comp_get_child(ui_temperatureComponent, ui_temperatureComponent_pending_checked == 0 ? UI_COMP_TEMPERATURECOMPONENT_TEMPERATURECOMPONENTTEMPS_TEMPERATURECOMPONENTBED : UI_COMP_TEMPERATURECOMPONENT_TEMPERATURECOMPONENTTEMPS_TEMPERATURECOMPONENTNOZZLE);
        if (target)
        {
            lv_obj_add_state(target, LV_STATE_CHECKED);
        }
        ui_temperatureComponent_pending_checked = -1;
    }
}
...
void ui_temperatureComponent_show_keypad_and_back(int type, int index, int backToScreen)
{
    ...
    ui_temperatureComponent_pending_keypad_type = type;
    ui_temperatureComponent_pending_keypad_index = index;
}

void ui_temperatureComponent_set_pending_checked(int index)
{
    ui_temperatureComponent_pending_checked = index;
    if (ui_temperatureComponent != NULL)
    {
        lv_obj_t *target = ui_comp_get_child(ui_temperatureComponent, index == 0 ? UI_COMP_TEMPERATURECOMPONENT_TEMPERATURECOMPONENTTEMPS_TEMPERATURECOMPONENTBED : UI_COMP_TEMPERATURECOMPONENT_TEMPERATURECOMPONENTTEMPS_TEMPERATURECOMPONENTNOZZLE);
        if (target)
        {
            lv_obj_add_state(target, LV_STATE_CHECKED);
        }
...
lv_obj_t *ui_temperatureComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_add_flag(cui_temperatureComponent, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_scrollbar_mode(cui_temperatureComponent, LV_SCROLLBAR_MODE_AUTO);
#else
    ...
    lv_obj_set_style_text_font(cui_mainScreenNozzleTempIcon, lv_icon_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_mainScreenBedTempIcon, lv_icon_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
...
#ifdef __XTOUCH_SCREEN_28__
    lv_obj_set_style_pad_left(cui_temperatureComponentPartFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_temperatureComponentPartFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_temperatureComponentPartFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_temperatureComponentPartFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
#else
    ...
    lv_obj_set_style_text_font(cui_temperatureComponentPartFanIcon, lv_icon_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(cui_temperatureComponentPartFanLabel, "ДЕТАЛЬ");
    lv_label_set_long_mode(cui_temperatureComponentPartFanLabel, LV_LABEL_LONG_DOT);
    ...
    lv_obj_set_width(cui_temperatureComponentPartFanInput, LV_SIZE_CONTENT); /* 5インチなど大フォントで切れないよう自動伸長 */
...
#ifdef __XTOUCH_SCREEN_28__
    lv_obj_set_style_pad_left(cui_temperatureComponentAuxFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_temperatureComponentAuxFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_temperatureComponentAuxFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_temperatureComponentAuxFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
#else
    ...
    lv_obj_set_style_text_font(cui_temperatureComponentAuxFanIcon, lv_icon_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(cui_temperatureComponentAuxFanLabel, "ВСПОМОГ.");
    lv_label_set_long_mode(cui_temperatureComponentAuxFanLabel, LV_LABEL_LONG_DOT);
    ...
    lv_obj_set_width(cui_temperatureComponentAuxFanInput, LV_SIZE_CONTENT); /* 5インチなど大フォントで切れないよう自動伸長 */
...
#ifdef __XTOUCH_SCREEN_28__
    lv_obj_set_style_pad_left(cui_temperatureComponentChamberFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_temperatureComponentChamberFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_temperatureComponentChamberFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_temperatureComponentChamberFan, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
#else
    ...
    lv_obj_set_style_text_font(cui_temperatureComponentChamberFanIcon, lv_icon_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(cui_temperatureComponentChamberFanLabel, "КАМЕРА");
    ...
    lv_obj_set_width(cui_temperatureComponentChamberFanInput, LV_SIZE_CONTENT); /* 5インチなど大フォントで切れないよう自動伸長 */
    ...
    lv_textarea_set_placeholder_text(cui_numpadInput, "Подсказка...");
    ...
    lv_obj_set_height(cui_numpadKey1, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey1, 1);
    lv_obj_set_align(cui_numpadKey1, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey2, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey2, 1);
    lv_label_set_text(cui_numpadKey2, "2");
    lv_obj_set_align(cui_numpadKey2, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey3, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey3, 1);
    lv_obj_set_align(cui_numpadKey3, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey4, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey4, 1);
    lv_obj_set_align(cui_numpadKey4, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey5, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey5, 1);
    lv_obj_set_align(cui_numpadKey5, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey6, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey6, 1);
    lv_obj_set_align(cui_numpadKey6, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey7, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey7, 1);
    lv_obj_set_align(cui_numpadKey7, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey8, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey8, 1);
    lv_obj_set_align(cui_numpadKey8, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey9, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey9, 1);
    lv_obj_set_align(cui_numpadKey9, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKey0, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKey0, 1);
    lv_obj_set_align(cui_numpadKey0, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKeyBack, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKeyBack, 1);
    lv_obj_set_align(cui_numpadKeyBack, LV_ALIGN_CENTER);
    ...
    lv_obj_set_height(cui_numpadKeyOk, lv_pct(25)); /// 48
    lv_obj_set_flex_grow(cui_numpadKeyOk, 1);
    lv_obj_set_align(cui_numpadKeyOk, LV_ALIGN_CENTER);
    ...
    lv_obj_add_event_cb(cui_temperatureComponentBed, ui_event_comp_temperatureComponent_temperatureComponentBed, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_temperatureComponentNozzle, ui_event_comp_temperatureComponent_temperatureComponentNozzle, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_temperatureComponentPartFan, ui_event_comp_temperatureComponent_temperatureComponentPartFan, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_temperatureComponentAuxFan, ui_event_comp_temperatureComponent_temperatureComponentAuxFan, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_temperatureComponentChamberFan, ui_event_comp_temperatureComponent_temperatureComponentChamberFan, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey1, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey2, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey3, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey4, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey5, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey6, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey7, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey8, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey9, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKey0, ui_event_comp_temperatureComponent_numpadKey, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKeyBack, ui_event_comp_temperatureComponent_numpadKeyBack, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_numpadKeyOk, ui_event_comp_temperatureComponent_numpadKeyOk, LV_EVENT_CLICKED, children);
