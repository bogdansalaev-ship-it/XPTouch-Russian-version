...
lv_obj_t *ui_hmsPanel_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(cui_hmsPanelCaption, "Вы уверены?");
    ...
    lv_label_set_text(cui_hmsPanelRetryButtonLabel, "Возобновить");
    ...
    lv_label_set_text(cui_hmsPanelDoneButtonLabel, "Готово");
    ...
    lv_label_set_text(cui_hmsPanelConfirmButtonLabel, "Подтвердить");
    ...
    lv_obj_add_event_cb(cui_hmsPanelConfirmButton, ui_event_comp_hmsPanel_onConfirmClick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_hmsPanelRetryButton, ui_event_comp_hmsPanel_onRetryClick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_hmsPanelDoneButton, ui_event_comp_hmsPanel_onDoneClick, LV_EVENT_CLICKED, children);
