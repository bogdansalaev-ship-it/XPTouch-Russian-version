...
void ui_comp_amsViewComponent_create_hook(lv_obj_t *comp)
{
    ...
    /* 2.8" экран: уменьшаем шрифт для AMS View */
    lv_obj_set_style_text_font(comp, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
#endif
}

void ui_comp_amsEditComponent_create_hook(lv_obj_t *comp)
{
#ifdef __XTOUCH_SCREEN_28__
    /* 2.8" экран: уменьшаем шрифт для AMS Edit */
    lv_obj_set_style_text_font(comp, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
#endif
}
