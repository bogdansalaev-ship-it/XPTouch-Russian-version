...
const char *xtouch_device_get_print_state()
{
    ...
    case XTOUCH_PRINT_STATUS_IDLE:
        return LV_SYMBOL_OK " Готово";
    case XTOUCH_PRINT_STATUS_FINISHED:
        return LV_SYMBOL_OK "Завершено";
    case XTOUCH_PRINT_STATUS_FAILED:
        return LV_SYMBOL_WARNING "Ошибка";
    default:
        return "Н/Д";
    }
}
...
void onXTouchPrintStatus(lv_event_t *e)
{
    ...
    case 48:
    {
        const char *msg = "Неизвестно";
        switch (bambuStatus.print_gcode_action)
        {
        case 0:  msg = "Ожидание нагрева"; break;
        case 1:  msg = "Выравнивание стола"; break;
        case 2:  msg = "Преднагрев стола"; break;
        case 3:  msg = "Компенсация вибрации"; break;
        case 8:  msg = "Калибровка"; break;
        case 13: msg = "Возврат головы"; break;
        case 14: msg = "Протирка сопла"; break;
        case 18: msg = "Микрокалибровка"; break;
        case 25: msg = "Подавление шума двигателя"; break;
        case 48: msg = "Подавление шума двигателя"; break;
        default: break;
        }
    ...
    case XTOUCH_PRINT_STATUS_PAUSED:
        ...
        if (statusCaption)
        {
            lv_label_set_text(statusCaption, LV_SYMBOL_PAUSE " Пауза");
...
// #endif
    ...
    lv_obj_add_flag(cui_mainScreenStatusLogo, LV_OBJ_FLAG_HIDDEN);

    /* Крупная красивая надпись "Bambu Lab" рядом со статусом принтера */
    lv_obj_t *cui_mainScreenBambuLabLabel = lv_label_create(ui_mainStatusComponent);
    lv_obj_set_width(cui_mainScreenBambuLabLabel, LV_SIZE_CONTENT);
    lv_obj_set_height(cui_mainScreenBambuLabLabel, LV_SIZE_CONTENT);
    lv_label_set_text(cui_mainScreenBambuLabLabel, "Bambu Lab");
    lv_obj_set_style_text_color(cui_mainScreenBambuLabLabel, lv_color_hex(0x00FF00), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(cui_mainScreenBambuLabLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(cui_mainScreenBambuLabLabel, lv_font_middle, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_clear_flag(cui_mainScreenBambuLabLabel, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE |
                          LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE |
                          LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_CHAIN);
    lv_obj_set_scrollbar_mode(cui_mainScreenBambuLabLabel, LV_SCROLLBAR_MODE_OFF);
    ...
    lv_label_set_text(cui_mainScreenStatusCaption, "Н/Д");
    ...
    lv_label_set_text(cui_mainScreenFinishedFailedLabel, "Завершено");
    ...
    lv_label_set_text(cui_mainScreenReprintButton, "Повтор");
    ...
    lv_label_set_text(cui_mainScreenTimeLeft, "Н/Д");
    ...
    lv_dropdown_set_options(cui_mainScreenSpeedDropDown, "Тихий\nСтандартный\nСпорт\nУльтра");
    ...
    lv_obj_add_event_cb(cui_mainScreenPlayPauseButton, ui_event_comp_homeComponent_mainScreenPlayPauseButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_mainScreenStopButton, ui_event_comp_homeComponent_mainScreenStopButton, LV_EVENT_CLICKED, children);
#if defined(__XTOUCH_SCREEN_50__)
    if (cui_mainScreenReprintButton)
        lv_obj_add_event_cb(cui_mainScreenReprintButton, ui_event_comp_homeComponent_mainScreenReprintButton, LV_EVENT_CLICKED, children);
#endif
    lv_obj_add_event_cb(cui_mainScreenSpeedDropDown, ui_event_comp_homeComponent_mainScreenSpeedDropDown, LV_EVENT_VALUE_CHANGED, children);
    lv_obj_add_event_cb(cui_mainScreenLightButton, ui_event_comp_homeComponent_mainScreenLightButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_mainScreenLCDButton, ui_event_comp_homeComponent_mainScreenLCDButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_mainScreenNeoPixelButton, ui_event_comp_homeComponent_mainScreenNeoPixelButton, LV_EVENT_CLICKED, children);

    lv_obj_add_event_cb(cui_mainScreenBedTemp, ui_event_comp_homeComponent_mainScreenBedTemp, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_mainScreenNozzleTemp, ui_event_comp_homeComponent_mainScreenNozzleTemp, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_mainScreenSpeedDropDown, ui_event_comp_homeComponent_mainScreenSpeedChange, LV_EVENT_VALUE_CHANGED, children);
