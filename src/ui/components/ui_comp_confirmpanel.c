...
lv_obj_t *ui_confirmPanel_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(cui_confirmPanelCaption, "Вы уверены?");
    lv_label_set_long_mode(cui_confirmPanelCaption, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_text(cui_confirmPanelNOLabel, "НЕТ");
    ...
    lv_label_set_text(cui_confirmPanelYESLabel, "ДА");
    ...
    lv_obj_add_event_cb(cui_confirmPanelNO, ui_event_comp_confirmPanel_confirmPanelNO, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_confirmPanelYES, ui_event_comp_confirmPanel_confirmPanelYES, LV_EVENT_CLICKED, children);
