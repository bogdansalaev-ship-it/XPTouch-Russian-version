...
lv_obj_t *ui_LightingPanel_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(cui_LightingPanelCaption, "Вы уверены?");
    ...
    lv_label_set_text(cui_LightingPanelNOLabel, "Камерный свет");
    ...
    lv_label_set_text(cui_LightingPanelYESLabel, "Свет NeoPixel");
    ...
    lv_obj_add_event_cb(cui_LightingPanelChamber, ui_event_comp_LightingPanel_LightingPanelNO, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_LightingPanelNeoPixel, ui_event_comp_LightingPanel_LightingPanelYES, LV_EVENT_CLICKED, children);
