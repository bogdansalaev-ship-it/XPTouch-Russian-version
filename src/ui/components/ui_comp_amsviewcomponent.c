...
lv_obj_t *ui_amsViewComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_add_flag(cui_amsViewComponent, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_scrollbar_mode(cui_amsViewComponent, LV_SCROLLBAR_MODE_AUTO);
#else
    ...
    lv_dropdown_set_options(cui_amsSelectorDropDown, "ВНЕШ");
    ...
    lv_label_set_text(cui_amsUnloadBtn_lbl, "ВЫГРУЗКА");
    lv_label_set_long_mode(cui_amsUnloadBtn_lbl, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_long_mode(cui_AmsHumid1, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_text(cui_AmsSlot1_1, "Слот 1");
    lv_label_set_long_mode(cui_AmsSlot1_1, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_text(cui_AmsSlot1_2, "Слот 2");
    lv_label_set_long_mode(cui_AmsSlot1_2, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_text(cui_AmsSlot1_3, "Слот 3");
    lv_label_set_long_mode(cui_AmsSlot1_3, LV_LABEL_LONG_DOT);
    ...
    lv_label_set_text(cui_AmsSlot1_4, "Слот 4");
    lv_label_set_long_mode(cui_AmsSlot1_4, LV_LABEL_LONG_DOT);
    ...
    lv_obj_set_style_border_width(row2_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            for (int b = 0; b < 2; b++)
            {
                ...
                lv_label_set_text(lbl, b == 0 ? LV_SYMBOL_EDIT : LV_SYMBOL_DOWN);
