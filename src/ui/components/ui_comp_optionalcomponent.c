...
lv_obj_t *ui_optionalComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text_fmt(cui_optionalTitle, LV_SYMBOL_SETTINGS " ДОПОЛНИТЕЛЬНО");
    ...
    lv_label_set_text(cui_optional_stackChanLabel, "Режим стекирования");
    ...
    lv_label_set_text(cui_optional_preheatLabel, "Кнопка подогрева");
    ...
    lv_label_set_text(cui_optional_multiPrinterMonitorLabel, "Монитор нескольких принтеров");
    ...
    lv_label_set_text(cui_optional_historyLabel, "Экран истории");
    ...
    lv_label_set_text(cui_optional_hideThumbnailsLabel, "Скрыть все миниатюры");
    ...
    lv_label_set_text(cui_optionalneoPixelTitle, LV_SYMBOL_LIST " NeoPixel(Опционально)");
    ...
    lv_obj_set_height(cui_optionalNeoPixelGpioHint, LV_SIZE_CONTENT);
    {
        ...
        if (pin <= 0)
            pin = 17;
        lv_label_set_text_fmt(cui_optionalNeoPixelGpioHint, "Подключите к GPIO%d", pin);
    }
    ...
    lv_label_set_text(cui_optionalNeoPixelNumPanelLabel, "Светодиоды");
    ...
    lv_label_set_text(cui_optionalNeoPixelBrightnessPanelLabel, "Яркость");
    ...
    lv_label_set_text(cui_optionalAlarmTimeoutPanelLabel, "Таймаут сирены");
    ...
    lv_label_set_text(cui_optional_Idle_ledLabel, "Светодиод простоя");
    ...
    lv_label_set_text(cui_optional_ds18b20Title, LV_SYMBOL_LIST " Датчик DS18B20 (Опция)");
...
#define _UI_CHAMBER_TEMP_PIN 22
    ...
    lv_label_set_text_fmt(cui_optional_ds18b20GpioHint, "Подключите к GPIO%d", _UI_CHAMBER_TEMP_PIN);
...
#undef _UI_CHAMBER_TEMP_PIN
    ...
    lv_label_set_text(cui_optional_chamberSensorLabel, "ТЕМП. КАМЕРЫ");
   ...
   lv_obj_add_event_cb(cui_optionalComponent, del_component_child_event_cb, LV_EVENT_DELETE, children);
    ...
    lv_obj_add_event_cb(ui_optionalNeoPixelNumSlider, ui_event_comp_optionalComponent_onNeoPixelNum, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
    lv_obj_add_event_cb(ui_optionalNeoPixelBrightnessSlider, ui_event_comp_optionalComponent_onNeoPixelBrightness, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
    lv_obj_add_event_cb(ui_optionalAlarmTimeoutSlider, ui_event_comp_optionalComponent_onAlarmTimeout, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
