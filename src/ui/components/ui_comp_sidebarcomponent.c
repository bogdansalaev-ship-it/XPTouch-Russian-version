...
lv_obj_t *ui_sidebarComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_add_event_cb(cui_sidebarHomeButton, ui_event_comp_sidebarComponent_sidebarHomeButton, LV_EVENT_CLICKED, children);
#ifdef __XTOUCH_SCREEN_50__
    lv_obj_add_event_cb(cui_sidebarPrintersButton, ui_event_comp_sidebarComponent_sidebarPrintersButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_sidebarHistoryButton, ui_event_comp_sidebarComponent_sidebarHistoryButton, LV_EVENT_CLICKED, children);
#endif
    lv_obj_add_event_cb(cui_sidebarTempButton, ui_event_comp_sidebarComponent_sidebarTempButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_sidebarAmsViewButton, ui_event_comp_sidebarComponent_sidebarAmsViewButton, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_sidebarSettingsButton, ui_event_comp_sidebarComponent_sidebarSettingsButton, LV_EVENT_CLICKED, children);
