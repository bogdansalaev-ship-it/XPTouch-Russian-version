...
lv_obj_t *ui_utilCalibrationComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text_fmt(cui_utilCalibrationTitle, LV_SYMBOL_SETTINGS " ВЫБОР КАЛИБРОВКИ");
    ...
    lv_checkbox_set_text(cui_utilCalibrationLidar, "Калибровка Лидара");
    ...
    lv_checkbox_set_text(cui_utilCalibrationBed, "Выравнивание стола");
    ...
    lv_checkbox_set_text(cui_utilCalibrationVibration, "Компенсация вибраций");
    ...
    lv_checkbox_set_text(cui_utilCalibrationMotor, "Подавление шума мотора");
    ...
    lv_label_set_text(cui_utilCalibrationButton, LV_SYMBOL_PLAY " Начать калибровку");
    ...
    lv_obj_add_event_cb(cui_utilCalibrationButton, ui_event_comp_utilCalibrationComponent_onSaveButtonClick, LV_EVENT_CLICKED, children);
