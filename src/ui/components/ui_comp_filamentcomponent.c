...
lv_obj_t *ui_filamentComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(cui_filamentScreenUnloadIcon, "ВЫГРУЗКА");
    ...
    lv_label_set_text(cui_filamentScreenLoadIcon, "ЗАГРУЗКА");
    ...
    // button click e
    lv_obj_add_event_cb(cui_filamentScreenNozzleUp, ui_event_comp_filamentComponent_filamentScreenNozzleUpClick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_filamentScreenNozzleDown, ui_event_comp_filamentComponent_filamentScreenNozzleDownCick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_filamentScreenUnload, ui_event_comp_filamentComponent_filamentScreenUnloadClick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_filamentScreenLoad, ui_event_comp_filamentComponent_filamentScreenLoadClick, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(cui_filamentScreenNozzleIcon, ui_event_comp_filamentComponent_onNozzleTempClick, LV_EVENT_CLICKED, children);
