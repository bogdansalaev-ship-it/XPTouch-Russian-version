...
static void update_temp_display(void)
{
    ...
    snprintf(buf_min, sizeof(buf_min), "Мин:%d", min_val);
    snprintf(buf_max, sizeof(buf_max), "Макс:%d", max_val);
...
lv_obj_t *ui_amsEditComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(s_lbl_temp_min, "Мин:0");
    ...
    lv_label_set_text(s_lbl_temp_max, "Макс:0");
    ...
    lv_label_set_text(lbl_reset, "Сброс");
