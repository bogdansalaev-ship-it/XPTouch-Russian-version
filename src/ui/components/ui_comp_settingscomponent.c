...
void ui_event_comp_settingsComponent_onSave(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_CLICKED)
    {
...
void ui_event_comp_settingsComponent_onLEDOFF(lv_event_t *e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    if (event_code == LV_EVENT_VALUE_CHANGED)
    {
        uint32_t value = lv_slider_get_value(ui_settingsLEDOFFSlider);
        lv_label_set_text_fmt(ui_settingsLEDOFFValue, "%dm", value);
        if (value < XTOUCH_LIGHT_MIN_SLEEP_TIME)
        {
            printf("onLEDOFF OFFSIMBOLE");
            lv_label_set_text(ui_settingsLEDOFFValue, LV_SYMBOL_POWER);
        }
        else
        {
            lv_label_set_text_fmt(ui_settingsLEDOFFValue, "%dm", value);
...
lv_obj_t *ui_settingsComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_set_style_bg_opa(cui_settingsComponent, 255, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
#endif
    lv_obj_add_flag(cui_settingsComponent, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_label_set_text_fmt(cui_settingsTitle, LV_SYMBOL_SETTINGS " НАСТРОЙКИ");
    ...
    lv_label_set_text(cui_screenTitle, LV_SYMBOL_IMAGE " Экран");
    ...
    lv_obj_set_width(cui_settingsBackLightPanelLabel, lv_pct(70));
    lv_obj_set_height(cui_settingsBackLightPanelLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settingsBackLightPanelLabel, LV_LABEL_LONG_WRAP);
    lv_label_set_text(cui_settingsBackLightPanelLabel, "Назад " LV_SYMBOL_CHARGE);
...
#ifdef __XTOUCH_SCREEN_28__
    lv_obj_set_x(ui_settingsBackLightPanelSlider, 0);
#else
    ...
    lv_obj_set_width(cui_settingsTFTOFFPanelLabel, lv_pct(70));
    lv_obj_set_height(cui_settingsTFTOFFPanelLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settingsTFTOFFPanelLabel, LV_LABEL_LONG_WRAP);
    lv_label_set_text(cui_settingsTFTOFFPanelLabel, "Сон");
    ...
    lv_obj_set_width(cui_screenWOPLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_screenWOPLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_screenWOPLabel, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_font(cui_screenWOPLabel, lv_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(cui_screenWOPLabel, LV_SYMBOL_EYE_OPEN " Пробуждаться при печати");
    ...
    lv_obj_set_width(cui_screenWDPLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_screenWDPLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_screenWDPLabel, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_font(cui_screenWDPLabel, lv_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(cui_screenWDPLabel, LV_SYMBOL_EYE_OPEN " Пробуждаться во время печати");
    ...
    lv_obj_set_width(cui_screenInvertLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_screenInvertLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_screenInvertLabel, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_font(cui_screenInvertLabel, lv_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(cui_screenInvertLabel, LV_SYMBOL_IMAGE " Инвертировать цвета");
    ...
    lv_obj_set_width(cui_settingsTFTFlipLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_settingsTFTFlipLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settingsTFTFlipLabel, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_font(cui_settingsTFTFlipLabel, lv_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(cui_settingsTFTFlipLabel, LV_SYMBOL_SHUFFLE " Перевернуть экран");
    ...
    lv_label_set_text(cui_ledTitle, LV_SYMBOL_IMAGE " КАМЕРНЫЙ СВЕТ");
    ...
    lv_obj_set_width(cui_settingsLEDOFFPanelLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_settingsLEDOFFPanelLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settingsLEDOFFPanelLabel, LV_LABEL_LONG_WRAP);
    lv_label_set_text(cui_settingsLEDOFFPanelLabel, "LED выкл");
    ...
    lv_obj_set_width(cui_settings_auxFanLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_settings_auxFanLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settings_auxFanLabel, LV_LABEL_LONG_WRAP);
    lv_label_set_text(cui_settings_auxFanLabel, "ВСПОМОГ. ВЕНТ");
    ...
    lv_obj_set_width(cui_settings_chamberFanLabel, lv_pct(70));  /// allow wrapping
    lv_obj_set_height(cui_settings_chamberFanLabel, LV_SIZE_CONTENT); /// 1
    lv_label_set_long_mode(cui_settings_chamberFanLabel, LV_LABEL_LONG_WRAP);
    lv_label_set_text(cui_settings_chamberFanLabel, "ВЕНТ. КАМЕРЫ");
    ...
    lv_obj_add_event_cb(ui_settingsTFTOFFSlider, ui_event_comp_settingsComponent_onTFTOFF, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
    lv_obj_add_event_cb(ui_settingsLEDOFFSlider, ui_event_comp_settingsComponent_onLEDOFF, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
    ...
    lv_obj_add_event_cb(ui_settingsBackLightPanelSlider, ui_event_comp_settingsComponent_onBackLight, LV_EVENT_VALUE_CHANGED | LV_EVENT_RELEASED, NULL);
    ...
    lv_obj_t *cui_saveButton = lv_label_create(cui_settingsComponent);
    lv_obj_set_width(cui_saveButton, lv_pct(100));
    lv_obj_set_height(cui_saveButton, LV_SIZE_CONTENT);
    lv_obj_set_style_text_font(cui_saveButton, lv_font_small, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(cui_saveButton, LV_SYMBOL_OK " Сохранить настройки");
    lv_obj_add_flag(cui_saveButton, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_clear_flag(cui_saveButton, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_scrollbar_mode(cui_saveButton, LV_SCROLLBAR_MODE_OFF);
    lv_obj_set_style_radius(cui_saveButton, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(cui_saveButton, lv_color_hex(0x2AFF00), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(cui_saveButton, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(cui_saveButton, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(cui_saveButton, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_saveButton, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_saveButton, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_saveButton, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(cui_saveButton, lv_color_hex(0x000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_event_cb(cui_saveButton, ui_event_comp_settingsComponent_onSave, LV_EVENT_CLICKED, NULL);
