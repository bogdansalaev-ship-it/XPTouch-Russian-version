...
lv_obj_t *ui_utilComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_label_set_text(button1, "Сопло\nВыбор");
    ...
    lv_label_set_text(button2, "Калибровка");
    ...
    lv_label_set_text(button3, "Заглушка3");
    /* Dummy3: イベントなし・常時無効 */
    lv_obj_add_state(button3, LV_STATE_DISABLED);
    ...
    lv_label_set_text(button4, "Заглушка4");
    ...
    // for NozzleSelect
    lv_obj_add_event_cb(button1, ui_event_comp_UtilComponent_onButton1Click, LV_EVENT_CLICKED, children);
    lv_obj_add_event_cb(button2, ui_event_comp_UtilComponent_onButton2Click, LV_EVENT_CLICKED, children);
