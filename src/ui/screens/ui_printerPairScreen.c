...
void ui_printerPairScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_printerPairScreenCaption, "Выберите принтер");
    ...
    lv_roller_set_options(ui_printerPairScreenRoller, LV_SYMBOL_CHARGE " Поиск принтеров...", LV_ROLLER_MODE_NORMAL);
