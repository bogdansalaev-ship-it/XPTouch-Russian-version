...
void xtouch_device_move_axis(String axis, double value, int speed)
{
    ...
    {
        ui_confirmPanel_show(LV_SYMBOL_WARNING " Запустить процесс центрирования?", ui_event_comp_controlComponent_controlScreenHomeConfirm);
        return;
    }
...
void xtouch_device_command_ams_load(void *s, lv_msg_t *m)
{
    ...
    {
        ui_confirmPanel_show(LV_SYMBOL_WARNING " Сначала установите тип филамента и температуру\nв AMS View / Edit.", ui_confirmPanel_hide);
        return;
    }
